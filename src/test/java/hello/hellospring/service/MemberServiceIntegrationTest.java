...
import hello.hellospring.repository.IMemberRepository;
...
//        try {
//            final Long saveId2 = memberService.join(member2);
//            fail();
//        } catch (IllegalStateException e) {
//            assertThat(e.getMessage()).isEqualTo("이미 존재하는 회원입니다.1231231232");
//        }
